...
export interface ApiCartUserCartUser extends Schema.CollectionType {
  collectionName: 'cart_users';
  info: {
    description: '';
    displayName: 'CartUser';
    pluralName: 'cart-users';
    singularName: 'cart-user';
  };
  options: {
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    orderAmount: Attribute.Decimal & Attribute.Required;
    orderItemList: Attribute.Component<'order-items.order-items', true>;
...
export interface ApiProductVariantProductVariant extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    publishedAt: Attribute.DateTime;
    qty: Attribute.Integer & Attribute.DefaultTo<0>;
    salePrice: Attribute.Decimal;
    Sizes: Attribute.Enumeration<['XS', 'S', 'M', 'L', 'XL']>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::cart-user.cart-user': ApiCartUserCartUser;
